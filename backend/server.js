...
const services = [
  {
    ...
    icon: "📄",
    description:
      "Professional ATS-optimized resume tailored to your target role.",
    features: [
  ...
  },
  {
    ...
    category: "linkedin",
    icon: "💼",
    description: "Boost your LinkedIn presence and get noticed by recruiters.",
    features: [
  ...
  },
  {
    ...
    category: "cover",
    icon: "✉️",
    description: "Compelling cover letters that get you through the door.",
    features: [
  ...
  },
  {
    ...
    category: "package",
    icon: "🚀",
    description: "Everything you need to transform your career profile.",
    features: [
      "ATS Resume",
  ...
  },
  {
    ...
    category: "interview",
    icon: "🎯",
    description: "Mock interviews and coaching to land your dream job.",
    features: [
  ...
  },
  {
    ...
    category: "strategy",
    icon: "🗺️",
    description: "Strategic job search plan tailored to your goals.",
    features: [
...
const plans = [
  {
    ...
    type: "test",
    badge: "Test",
    description: "Test payment processing (₹2 only)",
    features: [
      "Test Payment",
...
app.get("/api/health", (req, res) => {
  res.json({
    status: "OK",
    message: "Purnima Career Studio API",
